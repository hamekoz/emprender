class CreateEmprendimientos < ActiveRecord::Migration
  def change
    create_table :emprendimientos do |t|
      ...
      t.string :programas_sociales_recibidos, :default => ""
      t.string :tipo_de_ayuda_recibida_de_programas_sociales, :default => ""
      t.boolean :vinculado_a_sociedad_civil, :default => :false
      t.text :tipo_de_participacion_en_sociedad_civil, :default => ""
      t.boolean :recibio_ayuda_de_la_sociedad_civil, :default => :false
      t.text :justificacion_no_haber_recibido_ayuda_de_sociedad_civil, :default => ""
      ...
      t.text :posible_solucion_a_falta_de_espacio, :default => ""
      ...
      t.text :espacio_y_acondicinamiento_requeridos_para_crecer, :default => ""
      ...
      t.text :descripcion_de_competencia_en_mismo_barrio, :default => ""
      t.text :herramientas_necesarias, :default => ""
      t.text :maquinarias_necesarias, :default => ""
      t.text :movilidad_necesaria, :default => ""
      t.text :insumos_necesarios, :default => ""
      t.text :instalaciones_necesarias, :default => ""
      t.text :capacitaciones_necesaria, :default => ""
      t.text :otras_necesidades, :default => ""
      t.text :observaciones, :default => ""
