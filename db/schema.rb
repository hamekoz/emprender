...
ActiveRecord::Schema.define(version: 20130512010006) do
  ...
  create_table "emprendimientos", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["barrio_id"], name: "index_emprendimientos_on_barrio_id"
    t.index ["categoria_id"], name: "index_emprendimientos_on_categoria_id"
    t.index ["clasificacion_id"], name: "index_emprendimientos_on_clasificacion_id"
    t.index ["emprendedor_id"], name: "index_emprendimientos_on_emprendedor_id"
    t.index ["estado_id"], name: "index_emprendimientos_on_estado_id"
    t.index ["rubro_id"], name: "index_emprendimientos_on_rubro_id"
  end
  ...
  create_table "eventos", force: :cascade do |t|
    ...
    t.index ["barrio_id"], name: "index_eventos_on_barrio_id"
    t.index ["organizador_id"], name: "index_eventos_on_organizador_id"
  end

  create_table "informaciones", force: :cascade do |t|
    t.string "titulo"
    t.string "subtitulo"
    t.text "texto"
    t.integer "orden"
  ...
  create_table "instituciones", force: :cascade do |t|
    ...
    t.string "web"
    t.string "mail"
    t.index ["barrio_id"], name: "index_instituciones_on_barrio_id"
  end
  ...
  create_table "noticias", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["autor_id"], name: "index_noticias_on_autor_id"
  end
  ...
  create_table "perfiles", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["barrio_id"], name: "index_perfiles_on_barrio_id"
    t.index ["emprendedor_id"], name: "index_perfiles_on_emprendedor_id"
  end

  create_table "portadas", force: :cascade do |t|
    t.string "titulo"
    t.text "texto"
  ...
  create_table "productos", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["emprendimiento_id"], name: "index_productos_on_emprendimiento_id"
  ...
  create_table "servicios", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["emprendimiento_id"], name: "index_servicios_on_emprendimiento_id"
    t.index ["rubro_id"], name: "index_servicios_on_rubro_id"
  end
  ...
  create_table "usuarios", force: :cascade do |t|
    ...
    t.index ["aceptado"], name: "index_usuarios_on_aceptado"
