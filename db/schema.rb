...
ActiveRecord::Schema.define(:version => 20130422121800) do
  ...
  create_table "emprendimientos", :force => true do |t|
    ...
    t.timestamp "logotipo_updated_at"
    t.string    "nombre"
